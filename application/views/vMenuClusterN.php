                            ...
                            <div class="card wizard-card" data-color="rose" id="wizardProfile">
                                <form action="wizard.html" method="">
                                    ...
                                    <div class="wizard-navigation">
                                        <ul>
                                            <li>
                                                <a href="wizard.html#about" data-toggle="tab">About</a>
                                            </li>
                                            <li>
                                                <a href="wizard.html#account" data-toggle="tab">Account</a>
                                            </li>
                                            <li>
                                                <a href="wizard.html#address" data-toggle="tab">Address</a>
                                            </li>
                                        </ul>
                                    </div>
