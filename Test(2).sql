...
--
-- Host: localhost
-- Generation Time: Jan 10, 2018 at 12:06 PM
...
CREATE TABLE IF NOT EXISTS `clustering_option` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=970 ;
...
CREATE TABLE IF NOT EXISTS `clusters` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=39316 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=506445 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14816 ;
